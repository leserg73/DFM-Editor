...
begin
  ...
  BringtoFront;
  setWindowPos(form_DFMInspector.Handle,HWND_Bottom,0,0,0,0,SWP_NoMove or SWP_NoSize or SWP_NoActivate);
  setWindowPos(form_DFMPalette.Handle,HWND_Bottom,0,0,0,0,SWP_NoMove or SWP_NoSize or SWP_NoActivate);
  SetWindowPos(self.handle,hwnd_top,0,0,0,0,swp_noMove or swp_noSize or swp_noActivate);
end;
